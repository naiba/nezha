...
modify_agent_config() {
    ...
    if [ $# -lt 3 ]; then
        ...
        read -ep "Do you want to enable SSL/TLS encryption (--tls)? Press [y] if yes, the default is not required, and users can press Enter to skip if you don't understand: " nz_grpc_proxy
